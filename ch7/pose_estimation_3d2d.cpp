...
int main(int argc, char **argv) {
  ...
  // Creating 3D point
  Mat d1 = imread(argv[3], cv::IMREAD_UNCHANGED);       // depth map은 16bit unsigned int, single cannel 이미지 
  ...
  Mat r, t;
   // OpenCV의 PnP solver로 EPNP, DLS 등의 방법을 선택할 수 있음
  solvePnP(pts_3d, pts_2d, K, Mat(), r, t, false);
  Mat R;
  cv::Rodrigues(r, R); // r은 rotation vector form으로，Rodrigues 행렬로 변환
